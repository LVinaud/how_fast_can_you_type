...
Sparing the reader of further philosophy, although we did that a lot in this semester, we decide to make this word 100% AI free, so our game was 100% made by humans, it is way simpler than an OS and this text is also 100% AI free. But we also decided to document this moment, which is kind of a huge breakthrough and a new era for us(and even the pope considering its recent encyclical "Magnifica Humanitas" that is related to the "Rerum Novarum" from the industrial revolution).
